...
/* src/scripts/main.js */
    ...
    const HERO_IMAGES = [
      'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@tilda-prod/assets/images/cdn-cache/0b6b9a8c_day.png',
      'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@tilda-prod/assets/images/cdn-cache/4e868442_photo.png',
      'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@tilda-prod/assets/images/cdn-cache/ce98dc63_photo.png'
    ];
        ...
        videoList.innerHTML = mediaContent.videos.map((item) => `
          <div class="video-card" data-video="${item.url}">
            <div class="video-poster">
              ...
              <div class="video-play"><img class="ac-icon" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@tilda-prod/assets/icons/play.svg" alt="" aria-hidden="true" /></div>
            </div>
            <h4>${item.title}</h4>
          </div>
        `).join('');
    ...
    function runOfferSearch(){
      ...
      card.innerHTML = `
        <div class="offer-headline">
          ...
          <button class="form-close offer-close-btn" type="button" data-action="close-offer" aria-label="Закрыть"><img class="ac-icon" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@tilda-prod/assets/icons/close.svg" alt="" aria-hidden="true" /></button>
        </div>
