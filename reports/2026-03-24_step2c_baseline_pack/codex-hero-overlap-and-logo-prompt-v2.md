...
- include report
- additionally run CSS validation tools so we do not introduce fresh CSS debt

### Required CSS validation tools
Run and include results for:
- Stylelint
- CSSTree validator
- Project Wallace
- PurgeCSS estimate (analysis only, no deletion)

### What to state in the report about validation
Clearly state:
- whether Stylelint got worse / stayed stable / improved
- whether CSSTree stayed clean
- whether Wallace metrics changed materially
- whether the patch introduced any suspicious CSS growth or selector complexity
- whether this patch is architecturally clean enough to avoid fresh patch-on-patch debt
...
- `reports/2026-03-24_hero_overlap_logo_followup/validation/*`
...
10. screenshot list
11. CSS validation summary:
   - Stylelint
   - CSSTree
   - Project Wallace
   - PurgeCSS estimate
12. whether visual result matches requested intent
13. whether the patch stayed architecturally clean
...
- CSS validation is attached in the report
- no fresh CSS debt is introduced
