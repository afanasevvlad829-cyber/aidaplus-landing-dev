...
- Это основное эталонное состояние проекта (canonical visual state).
- Эта baseline-папка должна лежать в репозитории постоянно и использоваться как долгосрочный reference для всех следующих патчей.
