...
/* src/scripts/main.js */
    ...
    const mediaContent = {
      ...
      faq: [
        {
          group:'Медицина',
          icon:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/med.svg',
          items:[
        ...
        {
          group:'Безопасность',
          icon:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/lock.svg',
          items:[
        ...
        {
          group:'Питание',
          icon:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/food.svg',
          items:[
        ...
        {
          group:'Проживание',
          icon:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/check.svg',
          items:[
        ...
        {
          group:'Связь',
          icon:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/phone-mobile.svg',
          items:[
      ...
      team: [
        {
          ...
          avatarUrl:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/15b41072_photo.png',
        ...
        },
        {
          ...
          avatarUrl:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/dc9ef9b6_photo.png',
        ...
        },
        {
          ...
          role:'преподаватель Scratch, Minecraft и Python',
          avatarUrl:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/1e93e3b8_photo.png',
        ...
        },
        {
          ...
          avatarUrl:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/67852b0a_photo.png',
        ...
        },
        {
          ...
          avatarUrl:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/791a236a_ChatGPT_Image_18__20.png',
          bio:'помогает детям легко войти в программирование через игры, логику и первые самостоятельные программы.'
        }
      ],
      photos: [
        {cat:'all',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/atmosphere-pool-kids.jpeg',alt:'Атмосфера лагеря'},
        {cat:'all',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/a5f92a14_photo_2025-06-14_08-.jpg',alt:'all'},
        {cat:'all',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/8cca10f8_photo.jpg',alt:'all'},
        {cat:'all',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/1ac9b8f7_photo_2025-06-14_08-.jpg',alt:'all'},
        {cat:'all',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/1063273d_photo_2025-06-17_13-.jpg',alt:'all'},
        {cat:'study',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/a591ceb9_IMG_1543.JPG',alt:'study'},
        {cat:'food',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/9e4f4646_photo_2025-06-14_08-.jpg',alt:'food'},
        {cat:'food',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/8aee104b_photo_2025-06-14_08-.jpg',alt:'food'},
        {cat:'food',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/5babf9c8_photo.jpg',alt:'food'},
        {cat:'study',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/d8b90de0_photo_2025-06-14_08-.jpg',alt:'study'},
        {cat:'study',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/7e509c20_photo_2025-06-14_08-.jpg',alt:'study'},
        {cat:'study',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/81652cd9_photo_2025-06-14_08-.jpg',alt:'study'},
        {cat:'study',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/0e2e55a2_photo_2025-06-14_08-.jpg',alt:'study'},
        {cat:'pool',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/pool-kids-training.webp',alt:'Бассейн'},
        {cat:'pool',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/0d2ab9ef_photo_2025-06-14_08-.jpg',alt:'pool'},
        {cat:'pool',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/6a17713f_photo_2025-06-14_08-.jpg',alt:'pool'},
        {cat:'sport',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/cab7c193_photo.jpg',alt:'sport'},
        {cat:'sport',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/841dac3d_photo_2025-06-14_07-.jpg',alt:'sport'},
        {cat:'sport',src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/e7095a88_photo_2025-06-14_08-.jpg',alt:'sport'}
      ],
      videos: [
        {
    ...
    const CLOSE_ICON_HTML = '<img class="ac-icon" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/close.svg" alt="" aria-hidden="true">';
    ...
    const HERO_IMAGES = [
      'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/hero-camp-sunset-20260328.png'
    ];
    ...
    function handleDataActionClick(target){
      ...
      if(action === 'open-referral-photo'){
        activePhotoList = [{
          src:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/referral-hoodie.jpeg',
      ...
      if(action === 'open-book-photo'){
        activePhotoList = [{ src: 'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/8fc8172e_8991804334.webp', alt: 'Собственная книга по Python', cat: 'study' }];
        openMedia('photo', 0);
        return true;
      }
            ...
            <div class="booking-price-box booking-summary-mini booking-summary-mini--completed">
              <div class="booking-completed-top">
                <button class="booking-completed-reset" type="button" data-action="reset-booking-all" aria-label="Сбросить бронирование">
                  <img class="ac-icon" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/close.svg" alt="" aria-hidden="true">
                </button>
              </div>
              ...
              <button class="completed-followup-image-trigger" type="button" data-action="open-referral-photo" aria-label="Открыть фото в полном размере">
                <img class="completed-followup-image" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/referral-hoodie.jpeg" alt="Фирменная толстовка лагеря">
              </button>
              ...
              <span class="shift-option-price-row">
                ...
                <span class="shift-option-inline-actions">
                  <button class="shift-option-action shift-option-action-info" type="button" data-action="toggle-shift-about" data-shift-id="${s.id}" data-shift-view="${viewKey}" aria-label="Описание смены ${s.dates}">
                    <img class="ac-icon" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/info.svg" alt="" aria-hidden="true">
                  </button>
                  <button class="shift-option-action shift-option-action-calendar" type="button" data-action="toggle-shift-calendar-inline" data-shift-id="${s.id}" data-shift-view="${viewKey}" aria-label="Календарь ${s.dates}">
                    <img class="ac-icon" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/calendar.svg" alt="" aria-hidden="true">
                  </button>
                  <button class="shift-option-select-indicator" type="button" aria-label="Выбрать смену ${s.dates}">
                    <img class="ac-icon" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/chevron-right.svg" alt="" aria-hidden="true">
                  </button>
                </span>
              </span>
            </small>
    ...
    function contactIconMarkup(label){
      const map = {
        city_phone:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/phone-city.svg',
        mobile_phone:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/phone-mobile.svg',
        whatsapp:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/whatsapp.svg',
        telegram:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/telegram.svg'
      };
      const src = map[label];
        ...
        videoList.innerHTML = mediaContent.videos.map((item) => `
          <div class="video-card" data-video="${item.url}">
            <div class="video-poster">
              <img src="${item.cover || 'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/video-covers/cover-week-change.jpg'}" alt="${item.title}">
        ...
        <div class="team-card book-team-card">
          <div class="book-team-cover-wrap">
            <img
              ...
              src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/8fc8172e_8991804334.webp"
            ...
            <div class="team-right">
              ...
              <div class="team-carousel-shell">
                <button class="team-carousel-nav prev" type="button" data-action="team-carousel-prev" aria-label="Предыдущие преподаватели">
                  <img class="ac-icon" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/chevron-left.svg" alt="" aria-hidden="true">
                </button>
    ...
    function getCompactStayCards(){
      ...
      if(!cards.length){
        cards = [
          {
            img:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/53d52bed_45b1eb46cf5961c2188d.jpg.webp',
          ...
          {
            img:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/62b758b3_63e9322f53ec8ca1b307.jpg.webp',
            title:'Санузлы и бытовые зоны',
            text:'Родителям важно понимать не только программу, но и бытовой комфорт ребёнка.'
          },
          {
            img:'https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/stay-common-lounge.webp',
      ...
      mobileInlineTeamList.innerHTML = `
        <article class="mobile-team-feature-card">
          <div class="mobile-team-feature-cover-wrap" data-action="open-book-photo" role="button" tabindex="0" aria-label="Открыть обложку книги">
            <img class="mobile-team-feature-cover" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/images/cdn-cache/8fc8172e_8991804334.webp" alt="Собственная книга по Python">
          </div>
          ...
          const videoHtml = `
            <div class="mobile-media-stage mobile-video-stage">
              <button type="button" data-action="open-video" data-video="${active.url}">
                ...
                <span class="mobile-media-play"><img class="ac-icon" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/play.svg" alt="" aria-hidden="true"></span>
                <div class="mobile-media-overlay">
                  <strong>${active.title}</strong>
        ...
        ? `
          <div class="offer-state-shell offer-state-shell--search offer-state-shell--search-legacy">
            ...
            <div class="offer-legacy-search-icon" aria-hidden="true">
              <img class="offer-legacy-search-icon__asset" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/offer-search.svg" alt="">
            </div>
          ...
          <div class="offer-state-shell offer-state-shell--result offer-state-shell--result-legacy">
            ...
            <div class="offer-legacy-result-banner">
              <div class="offer-legacy-result-banner__icon" aria-hidden="true">
                <img class="offer-legacy-result-banner__asset" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@dev/cdn/assets/icons/search-job-svgrepo-com.svg" alt="">
              </div>
