...
/* src/scripts/main.js */
    ...
    const BUILD_VERSION_LABEL = 'v0.0.264 (mobile-menu-top-and-popups-centered)';
        ...
        shortGrid.innerHTML = shortShifts.map((s) => `
          <div class="mini-card short-shift-card">
            ...
            <div class="price-row">
              ...
              <span>
                ${s.dates} · ${shiftDaysLabel(s)}
                <small class="short-shift-subline">Короткий формат</small>
