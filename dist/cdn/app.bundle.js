        ...
        if(mainShifts.length){
          ...
          const programsHtml = `
            ...
            <article class="mobile-program-active-card">
              ...
              >
                <img class="ac-icon" src="https://cdn.jsdelivr.net/gh/afanasevvlad829-cyber/aidaplus-landing-dev@tilda-prod/cdn/assets/icons/calendar.svg" alt="" aria-hidden="true"><span>Календарь</span>
              </button>
            </article>
